...
export const metadata = {
  title: "Showcase | ink-scroll-list",
  description: "Interactive demonstrations of ink-scroll-list features.",
};
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            <APICard method="selectedIndex" desc="Controlled selection prop" />
            <APICard
              method="scrollAlignment"
              desc="auto | top | bottom | center"
            />
            <APICard method="scrollTo(y)" desc="Scroll to offset" />
            <APICard method="scrollBy(delta)" desc="Scroll by amount" />
            <APICard method="getItemPosition(i)" desc="Get item position" />
            <APICard method="remeasure()" desc="Force re-measure" />
          </div>
        </section>
        ...
        <section className="text-center py-8 border-t border-gray-200 dark:border-gray-800/50">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <a
              href="https://www.npmjs.com/package/ink-scroll-list"
              target="_blank"
              rel="noopener noreferrer"
