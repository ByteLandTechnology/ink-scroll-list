/**
 * @file shared.tsx
 * @description Shared UI components and theme constants for demo components
 *
 * This module provides reusable components for building consistent demo UIs:
 * - THEME: Color palette for consistent styling
 * - Btn: Button component with color variants
 * - StatusRow: Key-value display row
 * - ActionFeedback: Temporary feedback message display
 */
