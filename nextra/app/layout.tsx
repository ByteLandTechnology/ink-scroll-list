...
export const metadata: Metadata = {
  ...
  description:
    "Documentation for ink-scroll-list: A high-level ScrollList component for Ink CLI applications.",
};
...
const navbar = (
  ...
  >
    ...
    <a
      href="https://github.com/ByteLandTechnology/ink-scroll-list"
      target="_blank"
      rel="noreferrer"
    ...
    <html lang="en" dir="ltr" suppressHydrationWarning>
      ...
      <body className={`${exo2.variable} antialiased`}>
        ...
        <Layout
          navbar={navbar}
          pageMap={pageMap}
          docsRepositoryBase="https://github.com/ByteLandTechnology/ink-scroll-list/tree/main"
          footer={null}
